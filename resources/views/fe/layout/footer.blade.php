                    ...
                    <div class="login-content">
                        ...
                        <form action="#">
                            ...
                            <div class="member-register">
                                <p> Not a member? <a href="{{route('signin')}}"> Register now</a></p>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6 col-sm-12 col-xs-12 mb-lm-30px mb-md-30px mb-sm-30px">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto"
                                        src="{{url('assets')}}/images/product-image/zoom-image/1.jpg" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto"
                                        src="{{url('assets')}}/images/product-image/zoom-image/2.jpg" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto"
                                        src="{{url('assets')}}/images/product-image/zoom-image/3.jpg" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto"
                                        src="{{url('assets')}}/images/product-image/zoom-image/4.jpg" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="swiper-container zoom-thumbs mt-3 mb-3">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto"
                                        src="{{url('assets')}}/images/product-image/small-image/1.jpg" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto"
                                        src="{{url('assets')}}/images/product-image/small-image/2.jpg" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto"
                                        src="{{url('assets')}}/images/product-image/small-image/3.jpg" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto"
                                        src="{{url('assets')}}/images/product-image/small-image/4.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- Mirrored from htmldemo.hasthemes.com/jesco/jesco/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 May 2021 11:56:35 GMT -->
</html>