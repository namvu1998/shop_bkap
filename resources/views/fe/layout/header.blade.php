            ...
            <div class="row">
                <div class="col-auto align-self-center">
                    <div class="header-logo">
                        <a href="index.html"><img src="{{url('assets')}}/images/logo/logo.png" alt="Site Logo" /></a>
                    </div>
                </div>
                                        ...
                                        <ul class="menu-banner w-100">
                                            <li>
                                                <a class="p-0" href="shop-left-sidebar.html"><img
                                                        ...
                                                        src="{{url('assets')}}/images/banner/7.jpg" alt=""></a>
                                            </li>
                                            <li>
                                                <a class="p-0" href="shop-left-sidebar.html"><img
                                                        class="img-responsive w-100"
                                                        src="{{url('assets')}}/images/banner/8.jpg" alt=""></a>
                                            </li>
                                            <li>
                                                <a class="p-0" href="shop-left-sidebar.html"><img
                                                        class="img-responsive w-100"
                                                        src="{{url('assets')}}/images/banner/9.jpg" alt=""></a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    <li>
                        <a href="single-product.html" class="image"><img src="{{url('assets')}}/images/product-image/1.jpg"
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="{{url('assets')}}/images/product-image/2.jpg"
                                alt="Cart product Image"></a>
                        <div class="content">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="{{url('assets')}}/images/product-image/3.jpg"
                                alt="Cart product Image"></a>
                        <div class="content">
