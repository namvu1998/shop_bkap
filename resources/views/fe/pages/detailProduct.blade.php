                    ...
                    <div class="product">
                        <div class="thumb">
                            <a href="single-product.html" class="image">
                                ...
                                <img class="hover-image" src="{{url('assets')}}/images/product-image/5.jpg" alt="Product" />
                            </a>
                            <span class="badges">
                    ...
                    <div class="product">
                        <div class="thumb">
                            <a href="single-product.html" class="image">
                                ...
                                <img class="hover-image" src="{{url('assets')}}/images/product-image/11.jpg" alt="Product" />
                            </a>
                            <span class="badges">
