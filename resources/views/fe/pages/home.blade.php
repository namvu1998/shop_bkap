                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                ...
                                                <img class="hover-image" src="{{url('assets')}}/images/product-image/8.jpg"
                                                    alt="Product" />
                                            </a>
                                            <span class="badges">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                ...
                                                <img class="hover-image" src="{{url('assets')}}/images/product-image/10.jpg"
                                                    alt="Product" />
                                            </a>
                                            <span class="badges">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                ...
                                                <img class="hover-image" src="{{url('assets')}}/images/product-image/12.jpg"
                                                    alt="Product" />
                                            </a>
                                            <span class="badges">
                                            </span>
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                ...
                                                <img class="hover-image" src="{{url('assets')}}/images/product-image/14.jpg"
                                                    alt="Product" />
                                            </a>
                                            <span class="badges">
                                            </span>
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                ...
                                                <img class="hover-image" src="{{url('assets')}}/images/product-image/16.jpg"
                                                    alt="Product" />
                                            </a>
                                            <span class="badges">
                                                <span class="new">Sale</span>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="deal-inner deal-bg position-relative pt-100px pb-100px"
                        data-bg-image="{{url('assets')}}/images/deal-img/deal-bg.jpg">
