                        ...
                        <div class="col-xl-7 col-lg-7 col-md-7 col-sm-7 d-flex justify-content-center position-relative">
                            <div class="show-case">
                                <div class="hero-slide-image">
                                    <img src="{{url('assets')}}/images/slider-image/slider-1.png" alt="" />
                                </div>
                                <div class="display-wrapper">
                                    ...
                                    <div class="image-side">
                                        <img src="{{url('assets')}}/images/slider-image/display-image.png" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container align-self-center">
                    <div class="row">
                        ...
                        <div class="col-xl-7 col-lg-7 col-md-7 col-sm-7 d-flex justify-content-center position-relative">
                            <div class="show-case">
                                <div class="hero-slide-image">
                                    <img src="{{url('assets')}}/images/slider-image/slider-2.png" alt="" />
                                </div>
                                <div class="display-wrapper">
                                    <div class="content-side">
                                        <h4 class="title">Full Dress</h4>
        ...
        <div class="row">
            ...
            <div class="single-col center-col">
                <div class="single-banner">
                    <img src="{{url('assets')}}/images/banner/2.jpg" alt="">
                    <div class="item-disc">
            ...
            <div class="single-col">
                <a href="shop-left-sidebar.html" class="single-banner">
                    <img src="{{url('assets')}}/images/banner/3.jpg" alt="">
                    <div class="item-disc">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up" data-aos-delay="600">
                                ...
                                <div class="product">
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            <img src="{{url('assets')}}/images/product-image/5.jpg" alt="Product" />
                            ...
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up" data-aos-delay="800">
                                ...
                                <div class="product">
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            <img src="{{url('assets')}}/images/product-image/7.jpg" alt="Product" />
                                            <img class="hover-image" src="{{url('assets')}}/images/product-image/8.jpg" alt="Product" />
                                        </a>
                                        <span class="badges">
                            ...
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-md-30px mb-lm-30px" data-aos="fade-up" data-aos-delay="200">
                                ...
                                <div class="product">
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            <img src="{{url('assets')}}/images/product-image/2.jpg" alt="Product" />
                                            <img class="hover-image" src="{{url('assets')}}/images/product-image/10.jpg" alt="Product" />
                                        </a>
                                        <span class="badges">
                            ...
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6  mb-md-30px mb-lm-30px" data-aos="fade-up" data-aos-delay="400">
                                ...
                                <div class="product">
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            <img src="{{url('assets')}}/images/product-image/4.jpg" alt="Product" />
                                            <img class="hover-image" src="{{url('assets')}}/images/product-image/12.jpg" alt="Product" />
                                        </a>
                                        <span class="badges">
                                        </span>
                                        <div class="actions">
                            ...
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-es-30px" data-aos="fade-up" data-aos-delay="600">
                                ...
                                <div class="product">
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            <img src="{{url('assets')}}/images/product-image/6.jpg" alt="Product" />
                                            <img class="hover-image" src="{{url('assets')}}/images/product-image/14.jpg" alt="Product" />
                                        </a>
                                        <span class="badges">
                                        </span>
                                        <div class="actions">
                                ...
                                <div class="product">
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            ...
                                            <img class="hover-image" src="{{url('assets')}}/images/product-image/16.jpg" alt="Product" />
                                        </a>
                                        <span class="badges">
                                            <span class="new">Sale</span>
                                        </span>
            ...
            <div class="swiper-wrapper">
                    ...
                    <div class="testi-inner">
                        ...
                        <div class="testi-author">
                            <div class="author-img">
                                <img src="{{url('assets')}}/images/testimonial-image/1.png" alt="">
                            </div>
                ...
                <div class="swiper-slide">
                    <div class="testi-inner">
                        ...
                        <div class="testi-author">
                            <div class="author-img">
                                <img src="{{url('assets')}}/images/testimonial-image/2.png" alt="">
                            </div>
                            <div class="author-name">
                ...
                <div class="swiper-slide">
                    <div class="testi-inner">
                        ...
                        <div class="testi-author">
                            <div class="author-img">
                                <img src="{{url('assets')}}/images/testimonial-image/3.png" alt="">
                            </div>
                            <div class="author-name">
        ...
        <div class="brand-slider swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide brand-slider-item text-center">
                    <a href="#"><img class=" img-fluid" src="{{url('assets')}}/images/brand-logo/1.png" alt="" /></a>
                </div>
                <div class="swiper-slide brand-slider-item text-center">
                    <a href="#"><img class=" img-fluid" src="{{url('assets')}}/images/brand-logo/2.png" alt="" /></a>
                </div>
                <div class="swiper-slide brand-slider-item text-center">
                    <a href="#"><img class=" img-fluid" src="{{url('assets')}}/images/brand-logo/3.png" alt="" /></a>
                </div>
                <div class="swiper-slide brand-slider-item text-center">
                    <a href="#"><img class=" img-fluid" src="{{url('assets')}}/images/brand-logo/4.png" alt="" /></a>
                </div>
                <div class="swiper-slide brand-slider-item text-center">
                    <a href="#"><img class=" img-fluid" src="{{url('assets')}}/images/brand-logo/5.png" alt="" /></a>
                </div>
            </div>
        </div>
    </div>
