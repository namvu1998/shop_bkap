            ...
            <tbody>
                @foreach ($category as $item)
                    <tr>
                        ...
                        <td>
                            <a href="{{route('admin.category.edit',$item->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                            ...
                            <a href="{{route('admin.category.delete',$item->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
